...
data_summary = pd.read_csv('results/eda/summary_table.csv')
Markdown(data_summary.to_markdown(index = False))
```

![Correlation among features.](./results/eda/eda_heatmap.png){#fig-corr_heatmap width=70%}

![Distributions of features by wine quality](./results/eda/eda_hists.png){#fig-feature_dists width=80%}
